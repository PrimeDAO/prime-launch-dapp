...
@autoinject
export class Stage3 extends BaseStage<ILbpConfig> {
  ...
  getTokenInfo(): void {
    if (Utils.isAddress(this.launchConfig.tokenDetails.projectTokenAddress)) {
      if (this.lastCheckedLbpAddress !== this.launchConfig.tokenDetails.projectTokenAddress) {
        this.lastCheckedLbpAddress = this.launchConfig.tokenDetails.projectTokenAddress;
