...
export class Stage4 extends BaseStage<ISeedConfig> {
  ...
  async validateInputs(): Promise<string> {
    ...
    // } else if (this.launchConfig.launchDetails.seedTip === null) {
    //   message = "Please enter a number equal to or higher than 1% and lower than or equal to 45% for the tips";
    } else if (this.launchConfig.launchDetails.seedTip !== null && this.launchConfig.launchDetails.seedTip > 45) {
      message = "Please enter a number lower than or equal to 45% for the tips";
    } else if (this.launchConfig.launchDetails.seedTip !== null && this.launchConfig.launchDetails.seedTip < 1) {
