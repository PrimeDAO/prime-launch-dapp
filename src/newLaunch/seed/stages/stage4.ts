...
export class Stage4 extends BaseStage<ISeedConfig> {
  ...
  async validateInputs(): Promise<string> {
    ...
    } else if (this.launchConfig.tokenDetails.projectTokenAddress === this.launchConfig.launchDetails.fundingTokenAddress) {
      message = "Funding Token and Project Token cannot be same. Please reenter one or the other.";
