...
export class Stage4 extends BaseStage {
  ...
  validateInputs(): string {
    ...
    } else if (!this.startTimeHour || !this.startTimeMin) {
      message = "Please enter a value for the Start Time";
    } else if (this.startTimeHour > 24 || this.startTimeMin > 60) {
      message = "Please enter a valid value for Start Time";
    } else if (!this.endDate) {
      message = "Please select an End Date";
    } else if (!this.endTimeHour || !this.endTimeMin) {
      message = "Please enter a value for the End Time";
    } else if (this.endTimeHour > 24 || this.endTimeMin > 60) {
